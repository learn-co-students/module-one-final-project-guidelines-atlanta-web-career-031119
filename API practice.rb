...
while searching.downcase != "quit"
    ...
    movie_info = JSON.parse(RestClient.get("http://www.omdbapi.com/?s=#{searching}&apikey=92d4118f&"))  # General search that looks for movies with name -  movie_info = JSON.parse(RestClient.get("http://www.omdbapi.com/?s=#{searching}&apikey=92d4118f&"))
